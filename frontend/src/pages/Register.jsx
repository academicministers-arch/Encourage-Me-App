  ...
  return (
    <AuthLayout>
      ...
      >
        ...
        <h1 className="text-xl font-display font-bold text-navy text-center">Create your account</h1>
        <p className="text-sm text-ink/60 text-center mt-1">Start your personalized emotional wellness journey.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-ink/80 mb-1.5 block">Confirm password</label>
            <div className="relative">
              <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-ink/40" />
              <input
                type={showPassword ? 'text' : 'password'}
